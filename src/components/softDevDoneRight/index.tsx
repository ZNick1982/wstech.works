...
type SoftDevDoneRightProps = {
  children: ReactNode;
};

const SoftDevDoneRight = ({ children }: SoftDevDoneRightProps) => (
    ...
    <div className="max-w-screen-xl w-full flex flex-col px-4">
      <div className="flex justify-between">
        <h2 className="mt-20 mb-10 text-4xl uppercase text-blueMain text-left">
          <span className="text-orange">Software</span> Development Done Right
        </h2>
        <svg
          width="40"
          height="40"
...
export default SoftDevDoneRight;
export { DevLine };
